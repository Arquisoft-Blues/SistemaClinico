...
class ExamenAdmin(admin.ModelAdmin):
    list_display = ('id', 'paciente', 'tipo', 'get_resultado', 'get_fecha_realizacion')
    list_filter = ('tipo',)  
    search_fields = ('paciente__nombre', 'tipo')
    ...
    def get_fecha_realizacion(self, obj):
        return obj.fecha_realizacion if hasattr(obj, 'fecha_realizacion') else 'No disponible'
